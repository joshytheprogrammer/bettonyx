    ...
    <div class="flex flex-col lg:grid grid-cols-2 gap-12 items-start">
      ...
      <div class="text-sm md:text-base flex flex-col gap-4">
        ...
        <div class="border py-4 px-2" v-if="selectedTeam.id">
          <h2 class="text-2xl pb-6 underline underline-offset-[12px] decoration-primary-500">Event Slip</h2>
          <div class="flex gap-2 items-center font-semibold">
            <p class="w-fit bg-primary-400 dark:bg-primary-600 dark:text-white rounded-md p-3 text-sm" >{{ selectedTeam.odds }}x</p>
          ...
          <div class="py-4">
            ...
            <UButton v-else :loading="loading" :disabled="loading" class="bg-primary-800 flex items-center justify-center hover:bg-primary-900 text-center w-full rounded-md text-white py-2 text-sm" @click="placeEventBet">Place Event Bet</UButton>
          </div>
        </div>
