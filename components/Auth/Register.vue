<template>
  <section class="register w-full py-8 rounded-xl lg:shadow-lg" id="register">
    ...
    <div class="mt-10 w-full sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" @submit.prevent="register">
        ...
        <div>
          ...
          <div class="mt-2">
            <input type="email" autocomplete="email" required class="block w-full rounded-md border-0 p-1.5  shadow-sm outline-none ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-secondary-800 sm:text-sm sm:leading-6" v-model="user.email">
          </div>
        </div>
        ...
        <div>
          ...
          <div class="mt-2">
            <input type="password" autocomplete="current-password" required class="block w-full rounded-md border-0 p-1.5  outline-none shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-secondary-800 sm:text-sm sm:leading-6" v-model="confirmPassword">
          </div>
        </div>
        <div>
          <button
