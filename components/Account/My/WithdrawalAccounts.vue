<template>
  <div class="flex flex-col items-start justify-start gap-4">
    <h2 class="text-2xl pt-8 pb-4 font-medium underline decoration-secondary-900 dark:decoration-secondary-600 underline-offset-8	decoration-2 text-gray-900 dark:text-gray-200">Your Withdrawal Accounts</h2>
