  ...
  <div>
    <div v-if="editor" class="space-x-2 pt-1 pb-2">
      ...
      <!-- <button
        ...
        :class="{ 'is-active bg-slate-100 dark:bg-slate-400': editor.isActive('blockquote') }"
        class="w-6 py-1 px-1 active:ring-1 rounded-sm focus:ring-primary-500 "
      >
        blockquote
      </button>
...
const editor = useEditor({
  ...
  editorProps: {
    attributes: {
      class: "prose-sm w-full h-48 font-['Nunito sans'] focus:outline-none shadow-sm bg-white dark:bg-gray-900 text-gray-900 dark:text-white ring-1 ring-inset ring-gray-300 dark:ring-gray-700 focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400 rounded-md px-3 py-2 ",
    }, 
  },
});
